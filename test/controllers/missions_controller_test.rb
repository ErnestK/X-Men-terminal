...
class MissionsControllerTest < ActionController::TestCase
  ...
  test "should create mission" do
    assert_difference('Mission.count') do
      post :create, mission: { avatar: @mission.avatar, codename: @mission.codename, description: @mission.description, on_check: @mission.on_check }
    end
  ...
  test "should update mission" do
    patch :update, id: @mission, mission: { avatar: @mission.avatar, codename: @mission.codename, description: @mission.description, on_check: @mission.on_check }
    assert_redirected_to mission_path(assigns(:mission))
  end
