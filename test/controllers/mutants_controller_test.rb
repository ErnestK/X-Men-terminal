...
class MutantsControllerTest < ActionController::TestCase
  ...
  test "should create mutant" do
    assert_difference('Mutant.count') do
      post :create, mutant: { avatar: @mutant.avatar, d_birth: @mutant.d_birth, name: @mutant.name, skill: @mutant.skill }
    end
  ...
  test "should update mutant" do
    patch :update, id: @mutant, mutant: { avatar: @mutant.avatar, d_birth: @mutant.d_birth, name: @mutant.name, skill: @mutant.skill }
    assert_redirected_to mutant_path(assigns(:mutant))
  end
